...
$execute store result storage mc:_ temp.events.run.command."$(command)" int 4 run $(command)
$execute store result storage mc:_ temp.events.run.function."$(function)" int 4 run function $(function)
$execute store result storage mc:_ temp.events.clear."$(clear)" int 4 run clear @s $(clear)
$execute store result storage mc:_ temp.events.reload."$(reload)" int 4 run function custom_admin:$(reload)
